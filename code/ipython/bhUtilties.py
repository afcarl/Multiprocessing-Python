...
def multi_map(function, sequence, *args, **kwargs):
    ...
    list_of_list_of_files = np.array_split(sequence, pool_size * 3)
...
def timeItEnd(numIterations, startTimeLocal = None, printOn = True):
...
if __name__ == "__main__":
    print "Begin Main"
    # hold = splitAndCleanString("fdssd!fadffs234sdfds")
    # file = "/Users/bjherger/Documents/school/now/computational/hw/5.1 text/testData/2286newsML.xml"
    # hold = readXMLByTag(file, "p")
    # print hold

    print splitAndCleanString("! fun!")
    print "\nEnd Main"
